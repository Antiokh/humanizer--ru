...
Создание и редактирование GPT сейчас доступно платным пользователям ChatGPT в веб-интерфейсе. В managed workspace доступ дополнительно зависит от настроек пространства и роли пользователя. Перед публикацией проверяй актуальную справку OpenAI: условия могут меняться.
...
- очевидный повтор общей части в `не ошибка..., а ошибка...`;
